...
### 🚀 Added
- **The Claude Desktop extension is now attached to every release.** Download `gravitykit-mcp.mcpb` from the release page and open it — Claude Desktop asks for your site and credentials, with no config file to edit. The README links to the newest one.
